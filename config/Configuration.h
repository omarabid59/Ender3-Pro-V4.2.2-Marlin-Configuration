 ...
 *
 * G1 X50 Y50 Z1 ; Bottom Left
 * G1 X200 Y50 Z1 ; Bottom Right
* G1 X200 Y210 Z1.0 ; Top Right
* G1 X50 Y210 Z1.0 ; Top Left
 */
#pragma once
...
#define STRING_CONFIG_H_AUTHOR "(Omar, omarabid59, Ender-3 Pro)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
// Previously [XYZ]_PROBE_OFFSET_FROM_EXTRUDER
#define NOZZLE_TO_PROBE_OFFSET {0, -42, -2.95}

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
// Previously MIN_PROBE_EDGE
